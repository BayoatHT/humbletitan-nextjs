  ...
  return (
    <>
      <div className="abcd_container pt-5_abcd pb-5_abcd">
        <h1 className="pb-3_abcd blue-color_abcd text-transform_abcd">
          Result for
        </h1>
        <div className=" pb-5_abcd abcd_row abcd_justify-between">
          <h2 className="blue-color_abcd">
            Filter Label : {query?.filterlabel}{' '}
          </h2>
          <h2 className="blue-color_abcd">
            Filter Condition : {query?.filterCondition}{' '}
          </h2>
          <h2 className="blue-color_abcd">
            Filter Value : {query?.filterValue}{' '}
          </h2>
        </div>
        {customPages?.map((item, index) => {
          ...
          if (i !== 0 && i % 5 === 0) {
            return (
              <>
                <div
                  className="abcd_row mt-5_abcd abcd_justify-center abcd_wrap mb-2_abcd"
                  key={index}
                >
                ...
                <div
                  className="abcd_row abcd_justify-center abcd_wrap mb-2_abcd"
                  key={index}
                >
                  <div className="abcd_col-12  full-width_abcd">
                    <div className="keyvaluecard_abcd p-1_abcd">
                      ...
                      <div className="abcd_row abcd_justify-between p-1_abcd abcd_wrap">
                        <div className="abcd_col-4 custom-card-full-width">
                          <ul className="keyvalues_abcd mt-2_abcd topten-ul-border">
                            <li className="li_abcd">
                              <span className="abcd_width_50">
                                <strong>Country</strong>
                              </span>{' '}
                              <span className="abcd_width_50">
                                {item[1]?.country ? item[1]?.country : 'NA'}
                              </span>
                            </li>
                            <li className="li_abcd">
                              <span className="abcd_width_50">
                              ...
                              <span className="abcd_width_50">
                                {item[1]?.industry ? item[1]?.industry : 'NA'}{' '}
                              </span>
                            </li>
                            <li className="li_abcd">
                              <span className="abcd_width_50">
                            ...
                            <li className="li_abcd">
                              ...
                              <span className="red-bg_abcd abcd_width_50">
                                {item[1].mktcap ? item[1].mktcap : 'NA'}
                              </span>
                            </li>
                          </ul>
                        </div>
                        <div className="abcd_col-4 custom-card-full-width">
                          ...
                          <div className="abcd_row abcd_justify-around topten-ul-border col-gap-2r_abcd">
                            <div className="">
                              <div>
                                <p className="text-center_abcd">
                                  Net Profit Margin
                                </p>
                                <div className="abcd_row abcd_justify-center abcd_core-performance abcd_align-center m-auto custom-card-back_abcd">
                                  {item[0]?.netprofitmarginttm
                                    ? item[0]?.netprofitmarginttm
                                    : 'NA'}
                                </div>
                              </div>
                        ...
                        <div className="abcd_col-4 custom-card-full-width">
                          <h2 className="text-center_abcd">
                            Company Description
                          </h2>
                          <div>
                            <p className="customcard-para">
                              {item[1]?.description.length > MAX_LENGTH
                                ? `${item[1]?.description.substring(
                                    0,
                                    MAX_LENGTH,
                                  )}...`
                                : 'NA'}
