      ...
      <div className="container w-12/12 mx-auto bg-[#e0ecf0] max-w-screen-xl">
        <div className="mx-auto w-10/12 md:w-10/12 ">
          ...
          <p className="text-center font-regular text-[26px] leading-[35px] pt-8 m-auto text-[#023a51] w-[100%] lg:w-[70%] md:w-[95%] ">
            Find out where to vote. See what&apos;s on the ballot. Contact your
            election officials.
          </p>
          ...
          <div className="py-8 relative flex gap-x-[1%] gap-y-[16px] items-center justify-center flex-col md:flex-row">
            <input
              ...
              value={address}
              className=" border-width-[1px] border-slate-700 border-solid lg:w-[70%] h-[60px]  rounded-[5px] w-[100%] placeholder:italic placeholder:font-regular placeholder: leading-[20px]"
