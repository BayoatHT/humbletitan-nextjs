            ...
            <div className="container w-12/12 mx-auto  max-w-screen-xl rounded-lg mt-[0.5rem]">
              ...
              <div className="flex flex-wrap mb-10 mt-[0.5rem]  justify-start  items-center m-auto">
                ...
                <button
                  ...
                  className="bg-[#023a51] w-[100%] outline-0 cursor-pointer md:w-[17%] py-[5px] md:text[16px] lg:text-[18px] md:leading-[18px] lg:py-[15px] rounded-[5px] mt-4 mx-[5px]  font-bold text-[12px] leading-[13px] text-[#fff] hover:opacity-90 border-yellow"
                >
                  Filter
                </button>
              </div>
