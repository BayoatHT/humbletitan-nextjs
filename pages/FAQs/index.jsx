                        ...
                        <div className='mx-auto  w-10/12 md:w-11/12 bg-[#f9fafb] '>
                            ...
                            <div className='md:flex flex-wrap text-[#023A51] justify-around' >
                                <div className=' rounded-xl p-8 md:p-14 md:w-[45%] w-[90%]  mb-10' >
                                    <p className='text-[26px] font-semibold leading-[40px] '>Sed lectus purus lobortis eu aliquet?</p>
                                ...
                                <div className=' rounded-xl p-8 md:p-14 md:w-[45%] w-[90%]  mb-10' >
                                    <p className='text-[26px] font-semibold leading-[40px] '>Morbi augue egestas malesuada?</p>
                                    <p className='text-[20px] py-3' >Morbi bibendum eu velit mattis aliquam. Nulla ac ullamcorper dui, in dictum nibh. Aliquam ac dictum nunc, eget auctor est. Integer auctor imperdiet.</p>
                                </div>
                                <div className=' rounded-xl p-8 md:p-14 md:w-[45%] w-[90%]  mb-10' >
                                    <p className='text-[26px] font-semibold leading-[40px] '>Vivamus suscipit ut erat quis cursus?</p>
                                    <p className='text-[20px] py-3' >Morbi bibendum eu velit mattis aliquam. Nulla ac ullamcorper dui, in dictum nibh. Aliquam ac dictum nunc, eget auctor est. Integer auctor imperdiet.</p>
                                </div>
                                <div className=' rounded-xl p-8 md:p-14 md:w-[45%] w-[90%]  mb-10' >
                                    <p className='text-[26px] font-semibold leading-[40px] '>Donec bibendum enim at nunc accumsan sagittis?</p>
                                    <p className='text-[20px] py-3' >Morbi bibendum eu velit mattis aliquam. Nulla ac ullamcorper dui, in dictum nibh. Aliquam ac dictum nunc, eget auctor est. Integer auctor imperdiet.</p>
                                </div>
                                <div className=' rounded-xl p-8 md:p-14 md:w-[45%] w-[90%]  mb-10' >
                                    <p className='text-[26px] font-semibold leading-[40px] '>Aliquam pharetra nulla consequat dolor faucibus tempus?</p>
                                    <p className='text-[20px] py-3' >Morbi bibendum eu velit mattis aliquam. Nulla ac ullamcorper dui, in dictum nibh. Aliquam ac dictum nunc, eget auctor est. Integer auctor imperdiet.</p>
                                </div>
                                <div className=' rounded-xl p-8 md:p-14 md:w-[45%] w-[90%]  mb-10' >
                                    <p className='text-[26px] font-semibold leading-[40px] '>Vivamus suscipit ut erat quis cursu?</p>
                                    <p className='text-[20px] py-3' >Morbi bibendum eu velit mattis aliquam. Nulla ac ullamcorper dui, in dictum nibh. Aliquam ac dictum nunc, eget auctor est. Integer auctor imperdiet.</p>
                                </div>
                                <div className=' rounded-xl p-8 md:p-14 md:w-[45%] w-[90%]  mb-10' >
                                    <p className='text-[26px] font-semibold leading-[40px] '>Praesent finibus dolor at ligula rhoncus blandit leo?</p>
                                    <p className='text-[20px] py-3' >Morbi bibendum eu velit mattis aliquam. Nulla ac ullamcorper dui, in dictum nibh. Aliquam ac dictum nunc, eget auctor est. Integer auctor imperdiet.</p>
                                </div>
                                <div className=' rounded-xl p-8 md:p-14 md:w-[45%] w-[90%]  mb-10' >
                                    <p className='text-[26px] font-semibold leading-[40px] '>Nullam maximus ipsum in lectus gravida, nec luctus?</p>
                                    <p className='text-[20px] py-3' >Morbi bibendum eu velit mattis aliquam. Nulla ac ullamcorper dui, in dictum nibh. Aliquam ac dictum nunc, eget auctor est. Integer auctor imperdiet.</p>
                                </div>
                                <div className=' rounded-xl p-8 md:p-14 md:w-[45%] w-[90%]  mb-10' >
                                    <p className='text-[26px] font-semibold leading-[40px] '>Fusce a ligula convallis, efficitur nibh eget, rutrum erat?</p>
                                    <p className='text-[20px] py-3' >Morbi bibendum eu velit mattis aliquam. Nulla ac ullamcorper dui, in dictum nibh. Aliquam ac dictum nunc, eget auctor est. Integer auctor imperdiet.</p>
                                </div>
                                <div className=' rounded-xl p-8 md:p-14 md:w-[45%] w-[90%]  mb-10' >
                                    <p className='text-[26px] font-semibold leading-[40px] '>Aenean ex justo, tempor non nunc sed, ullamcorper molestie lectus?</p>
                                    <p className='text-[20px] py-3' >Morbi bibendum eu velit mattis aliquam. Nulla ac ullamcorper dui, in dictum nibh. Aliquam ac dictum nunc, eget auctor est. Integer auctor imperdiet.</p>
                                </div>
