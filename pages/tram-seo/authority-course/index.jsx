                        ...
                        <div className='mx-auto flex w-10/12 md:w-11/12  '>
                            <div className='md:flex items-center mx-auto justify-between' >
                                <div className='text-[#023A51] w-[100%] md:w-[50%]  ' >
                                    ...
                                    <br />
                                    <p className='text-[26px] ' >You become an authority in your niche either by getting extremely lucky or by implementing an intelligent strategy. This section is for those who won’t leave their digital success to chance.</p>
                                    <br />
