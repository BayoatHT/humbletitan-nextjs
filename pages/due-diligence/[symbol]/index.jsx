...
const CompantDetail = () => {
    ...
    cards: [
      ...
      },
      {
        ...
        listItems: [
          ...
          [
            'Earnings Yield',
            keymatrics?.earningsyieldttm ? keymatrics?.earningsyieldttm : 'NA',
          ],
          [
            'Graham Number',
            keymatrics?.grahamnumberttm ? keymatrics?.grahamnumberttm : 'NA',
          ],
          [
            'Interest Coverage',
            keymatrics?.interestcoveragettm
              ? keymatrics?.interestcoveragettm
              : 'NA',
          ],
      ...
      },
      {
        ...
        listItems: [
          ...
          [
            ...
            rating?.ratingrecommendation ? rating?.ratingrecommendation : 'NA',
          ],
          [
            'ROE Rating',
    ...
    cards: [
      {
        ...
        listItems: [
          [
            ...
            keymatrics?.receivablesturnoverttm
              ? keymatrics?.receivablesturnoverttm
              : 'NA',
          ],
          [
            'Payables Turnover',
            keymatrics?.payablesturnoverttm
              ? keymatrics?.payablesturnoverttm
              : 'NA',
          ],
          [
            'Inventory Turnover',
            keymatrics?.inventoryturnoverttm
              ? keymatrics?.inventoryturnoverttm
              : 'NA',
          ],
          [
            'Fixed Asset Turnover',
            financial?.fixedassetturnoverttm
              ? financial?.fixedassetturnoverttm
              : 'NA',
          ],
          [
            'Asset Turnover',
            financial?.assetturnoverttm ? financial?.assetturnoverttm : 'NA',
          ],
        ],
      },
      {
        ...
        listItems: [
          [
            'Debt Ratio',
            financial?.debtratiottm ? financial?.debtratiottm : 'NA',
          ],
          [
            'Debt Equity Ratio',
            financial?.debtequityratiottm
              ? financial?.debtequityratiottm
              : 'NA',
          ],
          [
            'Long Term Debt to Capitalization',
            financial?.longtermdebttocapitalizationttm
              ? financial?.longtermdebttocapitalizationttm
              : 'NA',
          ],
          [
            'Total Debt To Capitalization',
            financial?.totaldebttocapitalizationttm
              ? financial?.totaldebttocapitalizationttm
              : 'NA',
          ],
          [
            'Interest Coverage',
            financial?.interestcoveragettm
              ? financial?.interestcoveragettm
              : 'NA',
          ],
          [
            'Cashflow to Debt',
            financial?.cashflowtodebtratiottm
              ? financial?.cashflowtodebtratiottm
              : 'NA',
          ],
          [
            'Company Equity Multiplier',
            financial?.companyequitymultiplierttm
              ? financial?.companyequitymultiplierttm
              : 'NA',
          ],
        ],
      },
      {
        ...
        listItems: [
          [
            ...
            financial?.daysofpayablesoutstandingttm
              ? financial?.daysofpayablesoutstandingttm
              : 'NA',
          ],
          [
            'Days of Inventory Outstanding',
            financial?.daysofinventoryoutstandingttm
              ? financial?.daysofinventoryoutstandingttm
              : 'NA',
          ],
          [
            'Operating Cycle',
            financial?.operatingcyclettm ? financial?.operatingcyclettm : 'NA',
          ],
          [
          ...
          [
            ...
            financial?.cashconversioncyclettm
              ? financial?.cashconversioncyclettm
              : 'NA',
          ],
        ],
    ...
    cards: [
      {
        ...
        listItems: [
          [
            ...
            keymatrics?.salesgeneralandadministrativetorevenuettm
              ? keymatrics?.salesgeneralandadministrativetorevenuettm
              : 'NA',
          ],
          [
            'Research And Development To Revenue',
            keymatrics?.researchanddevelopementtorevenuettm
              ? keymatrics?.researchanddevelopementtorevenuettm
              : 'NA',
          ],
          [
            'Intangibles To Total Assets',
            keymatrics?.intangiblestototalassetsttm
              ? keymatrics?.intangiblestototalassetsttm
              : 'NA',
          ],
          [
            'Capex To Operating Cashflow',
            keymatrics?.capextooperatingcashflowttm
              ? keymatrics?.capextooperatingcashflowttm
              : 'NA',
          ],
          [
            'Capex to Revenue',
            keymatrics?.capextorevenuettm
              ? keymatrics?.capextorevenuettm
              : 'NA',
          ],
          [
            'Capex to Depreciation',
            keymatrics?.capextodepreciationttm
              ? keymatrics?.capextodepreciationttm
              : 'NA',
          ],
          [
            'Stock-based Compensation To Revenue',
            keymatrics?.stockbasedcompensationtorevenuettm
              ? keymatrics?.stockbasedcompensationtorevenuettm
              : 'NA',
          ],
        ],
      },
      {
        ...
        listItems: [
          [
            ...
            keymatrics?.freecashflowyieldttm
              ? keymatrics?.freecashflowyieldttm
              : 'NA',
          ],
          [
            'Income Quality',
            keymatrics?.incomequalityttm ? keymatrics?.incomequalityttm : 'NA',
          ],
          [
            'Return On Tangible Assets',
            keymatrics?.returnontangibleassetsttm
              ? keymatrics?.returnontangibleassetsttm
              : 'NA',
          ],
          [
            'Graham Net Net',
            keymatrics?.grahamnetnetttm ? keymatrics?.grahamnetnetttm : 'NA',
          ],
          [
            'Net Current Asset Value',
            keymatrics?.netcurrentassetvaluettm
              ? keymatrics?.netcurrentassetvaluettm
              : 'NA',
          ],
          [
            'Invested Capital',
            keymatrics?.investedcapitalttm
              ? keymatrics?.investedcapitalttm
              : 'NA',
          ],
          [
            'Days Sales Outstanding',
            keymatrics?.dayssalesoutstandingttm
              ? keymatrics?.dayssalesoutstandingttm
              : 'NA',
          ],
          [
            'Days Of Inventory On Hand',
            keymatrics?.daysofinventoryonhandttm
              ? keymatrics?.daysofinventoryonhandttm
              : 'NA',
          ],
        ],
      },
      {
        ...
        listItems: [
          [
            'Working Capital',
            keymatrics?.workingcapitalttm
              ? keymatrics?.workingcapitalttm
              : 'NA',
          ],
          [
            'Tangible Asset Value',
            keymatrics?.tangibleassetvaluettm
              ? keymatrics?.tangibleassetvaluettm
              : 'NA',
          ],
          [
            'Average Receivables',
            keymatrics?.averagereceivablesttm
              ? keymatrics?.averagereceivablesttm
              : 'NA',
          ],
          [
            'Average Payables',
            keymatrics?.averagepayablesttm
              ? keymatrics?.averagepayablesttm
              : 'NA',
          ],
          [
            'Average Inventory',
            keymatrics?.averageinventoryttm
              ? keymatrics?.averageinventoryttm
              : 'NA',
          ],
          [
            'Capex Per Share',
            keymatrics?.cashpersharettm ? keymatrics?.cashpersharettm : 'NA',
          ],
          [
            'Dividend Per Share',
            keymatrics?.dividendpersharettm
              ? keymatrics?.dividendpersharettm
              : 'NA',
          ],
          [
            'Debt To Market Cap',
            keymatrics?.debttomarketcapttm
              ? keymatrics?.debttomarketcapttm
              : 'NA',
          ],
        ],
  ...
  const FinancialHealth = {
    cards: [
      [
        'Gross Profit Margin',
        financial?.grossprofitmarginttm
          ? financial?.grossprofitmarginttm
          : 'NA',
      ],
      [
        'Operating Profit',
        financial?.operatingprofitmarginttm
          ? financial?.operatingprofitmarginttm
          : 'NA',
      ],
      [
        'Pre Tax Profit Margin',
        financial?.pretaxprofitmarginttm
          ? financial?.pretaxprofitmarginttm
          : 'NA',
      ],
      [
        'Net Profit Margin',
        financial?.netprofitmarginttm ? financial?.netprofitmarginttm : 'NA',
      ],
      [
        'Enterprise/EBITDA',
        keymatrics?.enterprisevalueoverebitdattm
          ? keymatrics?.enterprisevalueoverebitdattm
          : 'NA',
      ],
      [
        'EV to Sales',
        keymatrics?.evtosalesttm ? keymatrics?.evtosalesttm : 'NA',
      ],
      [
        'EV to Operating Cash Flow',
        keymatrics?.evtooperatingcashflowttm
          ? keymatrics?.evtooperatingcashflowttm
          : 'NA',
      ],
      [
        'EV to Free Cash Flow',
        keymatrics?.evtofreecashflowttm
          ? keymatrics?.evtofreecashflowttm
          : 'NA',
      ],
    ],
    ...
    cards: [
      {
        ...
        listItems: [
          ...
          [
            'Day Change',
            realtimequotes?.change ? realtimequotes?.change : 'NA',
          ],
          [
            '% Day Change',
            realtimequotes?.changespercentage
              ? realtimequotes?.changespercentage
              : 'NA',
          ],
          ...
          [
            'Day High',
            realtimequotes?.dayhigh ? realtimequotes?.dayhigh : 'NA',
          ],
      ...
      },
      {
        ...
        listItems: [
          [
            'Year Low',
            realtimequotes?.yearlow ? realtimequotes?.yearlow : 'NA',
          ],
          [
            'Year High',
            realtimequotes?.yearhigh ? realtimequotes?.yearhigh : 'NA',
          ],
          [
            '50 Day Avg.',
            realtimequotes?.priceavg50 ? realtimequotes?.priceavg50 : 'NA',
          ],
          [
            '200 Day Avg.',
            realtimequotes?.priceavg200 ? realtimequotes?.priceavg200 : 'NA',
          ],
          [
            '% of Year High',
            realtimequotes?.dayhigh ? realtimequotes?.dayhigh : 'NA',
          ...
          [
            '% of Year Low',
            realtimequotes?.daylow ? realtimequotes?.daylow : 'NA',
          ],
          [
            'Average Volume',
            realtimequotes?.avgvolume ? realtimequotes?.avgvolume : 'NA',
          ],
        ],
      },
    ],
  ...
  const Businessperformance = {
    cards: [
      [
        'Current Ratio',
        'Over 1',
        financial?.currentratiottm ? financial?.currentratiottm : 'NA',
        'OK',
        '1',
      ],
      [
        'Quick Ratio',
        'Over 1',
        financial?.quickratiottm ? financial?.quickratiottm : 'NA',
        'OK',
        '2',
      ],
      [
        'Cash Ratio',
        'Over 1',
        financial?.cashratiottm ? financial?.cashratiottm : 'NA',
        'OK',
        '4',
      ],
      [
        'Debt to Asset Ratio',
        'Over 1',
        keymatrics?.debttoassetsttm ? keymatrics?.debttoassetsttm : 'NA',
        'OK',
        '5',
      ],
      [
        ...
        'Over 1',
        keymatrics?.debttoequityttm ? keymatrics?.debttoequityttm : 'NA',
        'OK',
        '6',
      ],
      [
        ...
        'Over 1',
        keymatrics?.netdebttoebitdattm ? keymatrics?.netdebttoebitdattm : 'NA',
        'OK',
        '7',
      ],
      [
        'Return on Assets',
        'Over 1',
        financial?.returnonassetsttm ? financial?.returnonassetsttm : 'NA',
        'OK',
        '8',
      ],
      [
        'Return on Equity',
        'Over 1',
        financial?.returnonequityttm ? financial?.returnonequityttm : 'NA',
        'OK',
        '9',
      ],
      [
        ...
        'Over 1',
        financial?.returnoncapitalemployedttm
          ? financial?.returnoncapitalemployedttm
          : 'NA',
        'OK',
        '10',
    ...
    cards: [
      {
        ...
        listItems: [
          [
            ...
            financial?.priceearningsratiottm
              ? financial?.priceearningsratiottm
              : 'NA',
          ],
          [
            'Price /Earnings to Growth',
            financial?.priceearningstogrowthratiottm
              ? financial?.priceearningstogrowthratiottm
              : 'NA',
          ],
          [
            'Price /Book Value',
            financial?.pricebookvalueratiottm
              ? financial?.pricebookvalueratiottm
              : 'NA',
          ],
          [
            'Price /Sales',
            financial?.pricesalesratiottm
              ? financial?.pricesalesratiottm
              : 'NA',
          ],
          [
            'Price /Free Cashflow',
            financial?.pricetofreecashflowsratiottm
              ? financial?.pricetofreecashflowsratiottm
              : 'NA',
          ],
          [
            'Price /Operating Cashflow',
            financial?.pricetooperatingcashflowsratiottm
              ? financial?.pricetooperatingcashflowsratiottm
              : 'NA',
          ],
        ],
      },
      {
        ...
        listItems: [
          [
            'Revenue /share',
            keymatrics?.revenuepersharettm
              ? keymatrics?.revenuepersharettm
              : 'NA',
          ],
          [
            'Net Income /Share',
            keymatrics?.netincomepersharettm
              ? keymatrics?.netincomepersharettm
              : 'NA',
          ],
          [
            'Operating Cashflow /Share',
            keymatrics?.operatingcashflowpersharettm
              ? keymatrics?.operatingcashflowpersharettm
              : 'NA',
          ],
          [
            'Free Cashflow /Share',
            keymatrics?.freecashflowpersharettm
              ? keymatrics?.freecashflowpersharettm
              : 'NA',
          ],
          [
          ...
          [
            'Book Value /Share',
            keymatrics?.bookvaluepersharettm
              ? keymatrics?.bookvaluepersharettm
              : 'NA',
          ],
          [
            'Tangible book Value',
            keymatrics?.tangiblebookvaluepersharettm
              ? keymatrics?.tangiblebookvaluepersharettm
              : 'NA',
          ],
          [
            'Shareholder Equity /Share',
            keymatrics?.shareholdersequitypersharettm
              ? keymatrics?.shareholdersequitypersharettm
              : 'NA',
          ],
          [
            'Interest Debt /Share',
            keymatrics?.interestdebtpersharettm
              ? keymatrics?.interestdebtpersharettm
              : 'NA',
          ],
        ],
    ...
    cards: [
      {
        ...
        listItems: [
          ...
          [
            'Gross Profit',
            financialgrowth?.grossprofitgrowth
              ? financialgrowth?.grossprofitgrowth
              : 'NA',
          ],
          [
            'EBIT',
            financialgrowth?.ebitgrowth ? financialgrowth?.ebitgrowth : 'NA',
          ],
          [
            'Oper. Income',
            financialgrowth?.operatingincomegrowth
              ? financialgrowth?.operatingincomegrowth
              : 'NA',
          ],
          [
          ...
          [
            'Oper. Cash Flow',
            financialgrowth?.operatingcashflowgrowth
              ? financialgrowth?.operatingcashflowgrowth
              : 'NA',
          ],
          [
            'Free Cash Flow',
            financialgrowth?.freecashflowgrowth
              ? financialgrowth?.freecashflowgrowth
              : 'NA',
          ],
          [
            'EPS Diluted',
            financialgrowth?.epsdilutedgrowth
              ? financialgrowth?.epsdilutedgrowth
              : 'NA',
          ],
          [
            'EPS',
            financialgrowth?.epsgrowth ? financialgrowth?.epsgrowth : 'NA',
          ],
          [
            'Dividend Per Share',
            financialgrowth?.dividendspersharegrowth
              ? financialgrowth?.dividendspersharegrowth
              : 'NA',
          ],
        ],
      },
      {
        ...
        listItems: [
          [
            'Receivables',
            financialgrowth?.receivablesgrowth
              ? financialgrowth?.receivablesgrowth
              : 'NA',
          ],
          [
            'Inventory',
            financialgrowth?.inventorygrowth
              ? financialgrowth?.inventorygrowth
              : 'NA',
          ],
          [
            'Asset',
            financialgrowth?.assetgrowth ? financialgrowth?.assetgrowth : 'NA',
          ],
          [
            'Book Value',
            financialgrowth?.bookvaluepersharegrowth
              ? financialgrowth?.bookvaluepersharegrowth
              : 'NA',
          ],
          [
            'Debt',
            financialgrowth?.debtgrowth ? financialgrowth?.debtgrowth : 'NA',
          ],
          [
            'R/D Expense',
            financialgrowth?.rdexpensegrowth
              ? financialgrowth?.rdexpensegrowth
              : 'NA',
          ],
          [
            'SGA Expenses',
            financialgrowth?.sgaexpensesgrowth
              ? financialgrowth?.sgaexpensesgrowth
              : 'NA',
          ],
          [
            'Weighted Average Shares',
            financialgrowth?.weightedaveragesharesgrowth
              ? financialgrowth?.weightedaveragesharesgrowth
              : 'NA',
          ],
          [
            'Weighted Average Shares Diluted',
            financialgrowth?.weightedaveragesharesdilutedgrowth
              ? financialgrowth?.weightedaveragesharesdilutedgrowth
              : 'NA',
          ],
        ],
      },
      {
        ...
        listItems: [
          [
            'Revenue /Share',
            financialgrowth?.threeyrevenuegrowthpershare
              ? financialgrowth?.threeyrevenuegrowthpershare
              : 'NA',
          ],
          [
            'Operating Cash Flow /Share',
            financialgrowth?.threeyoperatingcfgrowthpershare
              ? financialgrowth?.threeyoperatingcfgrowthpershare
              : 'NA',
          ],
          [
            'Net Income /Share',
            financialgrowth?.threeynetincomegrowthpershare
              ? financialgrowth?.threeynetincomegrowthpershare
              : 'NA',
          ],
          [
            'Shareholders Equity /Share',
            financialgrowth?.threeyshareholdersequitygrowthpershare
              ? financialgrowth?.threeyshareholdersequitygrowthpershare
              : 'NA',
          ],
          [
            'Dividend /Share',
            financialgrowth?.threeydividendpersharegrowthpershare
              ? financialgrowth?.threeydividendpersharegrowthpershare
              : 'NA',
          ],
        ],
      },
      {
        ...
        listItems: [
          [
            'Revenue /Share',
            financialgrowth?.fiveyrevenuegrowthpershare
              ? financialgrowth?.fiveyrevenuegrowthpershare
              : 'NA',
          ],
          [
            'Operating Cash Flow /Share',
            financialgrowth?.fiveyoperatingcfgrowthpershare
              ? financialgrowth?.fiveyoperatingcfgrowthpershare
              : 'NA',
          ],
          [
            'Net Income /Share',
            financialgrowth?.fiveynetincomegrowthpershare
              ? financialgrowth?.fiveynetincomegrowthpershare
              : 'NA',
          ],
          [
            'Shareholders Equity /Share',
            financialgrowth?.fiveyshareholdersequitygrowthpershare
              ? financialgrowth?.fiveyshareholdersequitygrowthpershare
              : 'NA',
          ],
          [
            'Dividend /Share',
            financialgrowth?.fiveydividendpersharegrowthpershare
              ? financialgrowth?.fiveydividendpersharegrowthpershare
              : 'NA',
          ],
        ],
      },
      {
        ...
        listItems: [
          [
            'Revenue /Share',
            financialgrowth?.tenyrevenuegrowthpershare
              ? financialgrowth?.tenyrevenuegrowthpershare
              : 'NA',
          ],
          [
            'Operating Cash Flow /Share',
            financialgrowth?.tenyoperatingcfgrowthpershare
              ? financialgrowth?.tenyoperatingcfgrowthpershare
              : 'NA',
          ],
          [
            'Net Income /Share',
            financialgrowth?.tenynetincomegrowthpershare
              ? financialgrowth?.tenynetincomegrowthpershare
              : 'NA',
          ],
          [
            'Shareholders Equity /Share',
            financialgrowth?.tenyshareholdersequitygrowthpershare
              ? financialgrowth?.tenyshareholdersequitygrowthpershare
              : 'NA',
          ],
          [
  ...
  return (
    <div>
      <Layout>
        ...
        <Head>
          <title>
            {symbol?.toUpperCase()} Stock Report | {profile?.companyname} | DD
            by HT
          </title>
          <meta
            name="description"
            content={`Do your Due Diligence on ${profile?.companyname}. Make money the smart way. Discover and research the ${profile?.sector} sector before investing.`}
          />
          <meta
            name="keywords"
            content={`stocks, ${profile?.companyname}, ${profile?.sector} `}
          />
